...
#韩国：krvip002@hotmail.com/a12345678//
...
def get_anchor_list():
    ...
    # selectSql = "select display_id from tiktokmsg.anchor_msg where is_have_mcn is null and region = 'KR' and display_id != '' limit 30"
